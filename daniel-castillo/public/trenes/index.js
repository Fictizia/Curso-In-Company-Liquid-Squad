	var totTrains = 10,
	  ...
	  passengers = ['Alicia Gutierrez', 'Alfonso Gomez', 'Luis Navarro', 'Oscar Garcia', 'Andres Fernandez', 'Lucia Mellado']
	...
	function getTrainsList(totTrains, totWorking) {
	  ...
	  while (contador <= totTrains) {
	    console.log('El tren ' + contador + ' está ' + (contador <= totWorking ? working : stopped))
	    contador++
	  }
	}
	...
	function getTrainsList3(totTrains, totWorking) {
	  ...
	  for (var i = 0; i <= totTrains; i++) {
	    console.log('El tren ' + i + ' está ' + (i <= totWorking ? working : stopped))
	  }
	}
	...
	function getTrainsList4(totTrains, totWorking) {
	  ...
	  for (var i = 0; i <= totTrains; i++) {
	    console.log('El tren ' + i + ' está ' + getState(i))
	  }
	}
	...
	function getPassengers() {
	  ...
	  for (var i = 0; i <= passengers.length - 1; i++) {
	    ...
	    console.log('El pasajero ' + passengers[i] + ' tiene asignado el asiento ' + (i + 1))
	  }
	}
