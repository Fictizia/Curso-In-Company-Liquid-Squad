...
**Recursos**
- [Learn-regex by dwyl](https://github.com/dwyl/learn-regex/blob/master/README.md)
- [REGEX by Dave Child](https://media.cheatography.com/storage/thumb/davechild_regular-expressions.750.jpg)